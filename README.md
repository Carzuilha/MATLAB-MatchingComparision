This is a project on MATLAB that objective is to compare the number of matched points that can be obtained by a pair of stereo images, using a set of corner detectors algorithms. 
